      ...
      <div className='flex relative z-10 max-w-screen-xs sm:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg 3xl:pr-12'>
        <div className='relative z-10'>
          ...
          <p className={`mt-4 lg:mt-2 text-balance max-w-sm ${props.image ? 'lg:max-w-lg' : 'md:max-w-lg'} 2xl:max-w-screen-sm`}>
            ...
            <span className='text-sm/normal 2xl:text-base/normal opacity-60 font-light block md:mt-1'> with a creative background and a keen eye for detail, specialising in implementing designs with a focus on usability, conversion and performance.</span>
          </p>
        </div>
        {props.image && (
